...
\newacronym{ngcsacs}{NG-CSACs}{Next Generation Chip-Scale Atomic Clocks}
...
\input{src/02 - objective_metrics.tex}
\input{src/03 - working_principles.tex}
\input{src/04 - performances_and_limitations.tex}
\input{src/05 - applications.tex}
\input{src/06 - future_prospects.tex}
