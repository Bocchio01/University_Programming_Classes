...
% Long term stability -> Drift -> Holdover capabilities
%
...
\begin{frame}{Short term stability (Allan deviation $\sigma_y(\tau)$)}
    ...
    \footnotetext{
        $\sigma_y(\tau) = 3\times10^{-9}$ at $\tau = 1s$ is equivalent to an instability in frequency between two observations 1 second apart with a (RMS) value of $3\times10^{-9}$.
